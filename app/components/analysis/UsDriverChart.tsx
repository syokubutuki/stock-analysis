              ...
              <>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
                  <div className="p-2 rounded border border-gray-200 bg-gray-50">
                    ...
                    <div className={`font-medium ${directionClass(divergence.intraAligned)}`}><DirectionGlyph value={divergence.intraAligned} />日中 {fmtSignedPct(divergence.intraAligned)}</div>
                  </div>
                  <div className="p-2 rounded border border-purple-200 bg-purple-50">
                    ...
                    <div className={`font-medium ${directionClass(divergence.intraDiverge)}`}><DirectionGlyph value={divergence.intraDiverge} />日中 {fmtSignedPct(divergence.intraDiverge)}</div>
                  </div>
