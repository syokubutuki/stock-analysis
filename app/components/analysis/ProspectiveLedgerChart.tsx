                  ...
                  >
                    ...
                    {ev ? (
                      <>
                        ...
                        <td className={`text-right px-1 font-mono ${directionClass(ev.muOOS)}`}><DirectionGlyph value={ev.muOOS} />{(ev.muOOS * 100).toFixed(3)}%</td>
                        <td className="text-right px-1 font-mono">{ev.sharpeOOS.toFixed(2)}</td>
                        <td className={`text-right px-1 font-mono ${directionClass(ev.cumOOS)}`}><DirectionGlyph value={ev.cumOOS} />{(ev.cumOOS * 100).toFixed(1)}%</td>
