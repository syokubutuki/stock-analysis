...
export const ANALYSIS_GUIDES: readonly AnalysisGuideEntry[] = [
  ...
  {
    slug: "investor-bias",
    title: "投資家の認知バイアスとは？アンカリング・損失回避を自分の銘柄で測る",
    shortTitle: "投資家バイアス・コーチ",
    description:
      "アンカリング、ディスポジション効果、損失回避、モメンタム/リバーサルを実際の株価データで定量化し、売買行動を変えるためのチェックリストに落とす方法を解説します。",
    category: "行動ファイナンス",
    keywords: ["認知バイアス", "アンカリング", "損失回避", "ディスポジション効果", "行動ファイナンス", "塩漬け"],
    section: "basic",
    panel: "basic-bias-coach",
    period: "10y",
    seriesMode: "close",
    summary:
    ...
    formulas: [
      {
        label: "52週高値比率",
        tex: "\\mathrm{PH}_t=\\frac{C_t}{\\max_{t-251\\le s\\le t}C_s}",
        explanation:
          "現在値が過去1年の高値の何割かを表します。George-Hwangの52週高値効果で使われる標準的な定義です。",
      },
      {
        label: "アンカリングの判定",
        tex: "\\Delta=\\mathbb{E}\\!\\left[r^{(20)}\\,\\middle|\\,\\mathrm{PH}>0.9\\right]-\\mathbb{E}\\!\\left[r^{(20)}\\,\\middle|\\,\\mathrm{PH}\\le 0.7\\right]",
        explanation:
          "Δ>0なら高値近辺のほうがその後が良く、高値をアンカーとした過小反応（アンカリング効果）と解釈します。Δ<0なら平均回帰型です。",
      },
      {
        label: "WMLとt値",
        tex: "\\mathrm{WML}=\\bar r_{win}-\\bar r_{lose},\\qquad t=\\frac{\\mathrm{WML}}{s/\\sqrt n}",
        explanation:
          "勝者群と敗者群の平均リターンの差です。短期20日と長期120日の2つの形成期間で計算します。",
      },
      {
        label: "損失回避の非対称性",
        tex: "A=\\lambda\\,\\frac{\\overline{|r^-|}}{\\overline{r^+}},\\qquad \\lambda\\approx 2.25",
        explanation:
          "λはKahneman-Tverskyのプロスペクト理論で推定された損失回避係数です。Aは「下落の痛みが上昇の喜びの何倍か」の目安を与えます。",
      },
    ],
    terms: [
      { term: "アンカリング", definition: "最初に見た数値（52週高値など）に判断が引きずられる傾向です。" },
      { term: "ディスポジション効果", definition: "含み益は早く確定し、含み損は抱え続ける傾向です。合理的な保有判断を歪めます。" },
      { term: "損失回避", definition: "同じ金額でも損失の痛みが利益の喜びより大きく感じられる性質です。" },
      { term: "ハウスマネー効果", definition: "儲けた資金は「あぶく銭」と感じ、リスクを取りすぎる傾向です。" },
      { term: "事前コミットメント", definition: "感情が動く前にルールを決めておく手法です。チェックリストはその道具です。" },
    ],
    example:
    ...
    related: ["structure-scorecard", "weekday-effect", "walk-forward"],
  },
] as const;
