...
import { studentTwoSidedP } from "./stats-significance";
...
// t分布の分布関数(不完全ベータ関数)は stats-significance に一元化してある。
// 以前はここに私的コピーを置いていたが、x→1 側で連分数が収束せず |t| が小さいときの
// p値が不当に小さく出る欠陥版だったため委譲に統一した。
