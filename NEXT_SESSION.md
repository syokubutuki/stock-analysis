...
> ## ⚠ 2026-08-31 更新 — **本書の残件は全部片付いた。運用の正は別文書である**
>
...
> 次に投げるのは **S20（A3 = Canvas 代替テキストの残り ＋ FU36 / FU37 / FU39）。単独で投げること。**
> S14 / S16 / S15 / S17 / S18 / **S19** はマージ済み。本書は設計の記録として残しているだけで、
> **「次に何をやるか」をここから読まないこと。**
>
...
> `node docs/tools/build-session-prompts.mjs S20` で作る（`docs/prompts/` を直接編集しない）。
